import{_ as r,r as l,o as c,c as o,a as n,b as i,d as e,w as a,e as d}from"./app-d062b0bc.js";const u={},v=i("h1",{id:"toc",tabindex:"-1"},[i("a",{class:"header-anchor",href:"#toc","aria-hidden":"true"},"#"),e(" toc")],-1),p=d(`<p>该插件会提供一个目录 (table-of-contents, TOC) 组件。</p><h2 id="使用方法" tabindex="-1"><a class="header-anchor" href="#使用方法" aria-hidden="true">#</a> 使用方法</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>npm i -D @vuepress/plugin-toc@next
