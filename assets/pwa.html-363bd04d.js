...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="配置项" tabindex="-1"><a class="header-anchor" href="#配置项" aria-hidden="true">#</a> 配置项</h2>`,2),y={href:"https://developers.google.com/web/tools/workbox/reference-docs/latest/module-workbox-build#.generateSW",target:"_blank",rel:"noopener noreferrer"},E=e("code",null,"globDirectory",-1),V=e("code",null,"swDest",-1),A=r(`<p>比如，你可以设置 <code>skipWaiting: true</code> ，这将在新的 Service Worker 就绪之后立即激活它：</p><div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code>export default {
  plugins: [
    pwaPlugin({
      skipWaiting: true,
    }),
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>但是如果你不设置 <code>skipWaiting</code> 或设置为 <code>false</code> ，你就需要手动激活新的 Service Worker 。</p>`,3),z=e("li",null,[i("对于开发者，你可以使用该插件提供的 "),e("a",{href:"#composition-api"},"Composition API"),i(" 来控制 Service Worker 的行为。")],-1),B=e("h3",{id:"serviceworkerfilename",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#serviceworkerfilename","aria-hidden":"true"},"#"),i(" serviceWorkerFilename")],-1),M=e("li",null,[e("p",null,[i("类型： "),e("code",null,"string")])],-1),N=e("li",null,[e("p",null,[i("默认值： "),e("code",null,"'service-worker.js'")])],-1),D=e("p",null,"详情：",-1),C=e("p",null,[i("Service Worker 文件只会在 "),e("code",null,"build"),i(" 模式下生成。")],-1),I=e("h2",{id:"composition-api",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#composition-api","aria-hidden":"true"},"#"),i(" Composition API")],-1),j=e("h3",{id:"usepwaevent",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#usepwaevent","aria-hidden":"true"},"#"),i(" usePwaEvent")],-1),J=e("p",null,"详情：",-1),L=e("p",null,"返回该插件的 Event Emitter 。",-1),R={href:"https://github.com/yyx990803/register-service-worker",target:"_blank",rel:"noopener noreferrer"},G=e("li",null,[e("p",null,"示例：")],-1),F=r(`<div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code>import { usePwaEvent } from &#39;@vuepress/plugin-pwa/client&#39;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="useskipwaiting" tabindex="-1"><a class="header-anchor" href="#useskipwaiting" aria-hidden="true">#</a> useSkipWaiting</h3><ul><li>参数：</li></ul><table><thead><tr><th>参数</th><th>类型</th><th>描述</th></tr></thead><tbody><tr><td>registration</td><td><code>ServiceWorkerRegistration</code></td><td>你想要激活的 Service Worker 的 Registration</td></tr></tbody></table>`,4),U=e("p",null,"详情：",-1),H={href:"https://developer.mozilla.org/en-US/docs/Web/API/ServiceWorkerGlobalScope/skipWaiting",target:"_blank",rel:"noopener noreferrer"},T=e("li",null,[e("p",null,"示例：")],-1),K=r(`<div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code>import {
  usePwaEvent,
  useSkipWaiting,
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,1);function O(Q,X){const o=a("NpmBadge"),s=a("ExternalLinkIcon"),t=a("RouterLink");return c(),u("div",null,[p,n(o,{package:"@vuepress/plugin-pwa"}),e("p",null,[i("使你的 VuePress 站点成为一个 "),e("a",m,[i("渐进式 Web 应用 (PWA)"),n(s)]),i(".")]),e("p",null,[i("该插件使用 "),e("a",b,[i("workbox-build"),n(s)]),i(" 来生成 Service Worker 文件，并通过 "),e("a",h,[i("register-service-worker"),n(s)]),i(" 来注册 Service Worker 。")]),_,e("p",null,[i("为了使你的网站符合 PWA 的要求，你需要创建一个 "),e("a",g,[i("Web app manifests"),n(s)]),i(" 文件，并且为你的 PWA 设置图标、颜色等信息。")]),e("p",null,[i("你需要将你的 Manifest 文件和图标放置在 "),n(t,{to:"/DocVuepress/Java/guide/assets.html#public-%E6%96%87%E4%BB%B6"},{default:l(()=>[i("Public 目录")]),_:1}),i(" 下。在下述的示例中，我们假设你正在使用默认的 Public 目录 "),f,i(" 。")]),k,e("div",q,[w,e("p",null,[i("一些工具可以帮助你做这些事。比如 "),e("a",x,[i("Favicon Generator"),n(s)]),i(" 可以帮助你生成图片以及一个 Manifest 文件样例。")])]),W,e("p",null,[i("你还需要通过 "),n(t,{to:"/DocVuepress/Java/reference/config.html#head"},{default:l(()=>[i("head")]),_:1}),i(" 配置项来设置一些标签，用来 "),e("a",S,[i("部署你的 Manifest 文件"),n(s)]),i(" 。")]),P,e("p",null,[i("该插件的配置项可以接收 workbox-build 中 "),e("a",y,[i("generateSW 方法"),n(s)]),i(" 除了 "),E,i(" 和 "),V,i(" 以外的所有参数。")]),A,e("ul",null,[e("li",null,[i("对于用户，你可以配合我们提供的 "),n(t,{to:"/DocVuepress/Java/reference/plugin/pwa-popup.html"},{default:l(()=>[i("pwa-popup")]),_:1}),i(" 插件一起使用。")]),z]),B,e("ul",null,[M,N,e("li",null,[D,e("p",null,[i("生成的 Service Worker 文件路径，该路径是 "),n(t,{to:"/DocVuepress/Java/reference/config.html#dest"},{default:l(()=>[i("dest")]),_:1}),i(" 目录的相对路径。")]),C])]),I,j,e("ul",null,[e("li",null,[J,L,e("p",null,[i("你可以为 "),e("a",R,[i("register-service-worker"),n(s)]),i(" 提供的事件添加事件监听器。")])]),G]),F,e("ul",null,[e("li",null,[U,e("p",null,[i("调用 "),e("a",H,[i("skipWaiting()"),n(s)]),i(" 来激活处于 Waiting 状态的 Service Worker 。")])]),T]),K])}const Z=d(v,[["render",O],["__file","pwa.html.vue"]]);export{Z as default};
