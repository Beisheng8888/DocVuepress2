import{_ as l,r,o as t,c as o,b as a,d as e,a as s,w as n,e as d}from"./app-6ea6c10f.js";const c="/DocVuepress/images/hero.png",u={},m=d(`<h1 id="静态资源" tabindex="-1"><a class="header-anchor" href="#静态资源" aria-hidden="true">#</a> 静态资源</h1><h2 id="相对路径" tabindex="-1"><a class="header-anchor" href="#相对路径" aria-hidden="true">#</a> 相对路径</h2><p>你可以在你的 Markdown 内容中使用相对路径来引用静态资源：</p><div class="language-markdown line-numbers-mode" data-ext="md"><pre class="language-markdown"><code>![图片](./image.png)
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,11),x={class:"custom-container tip"},P=a("p",{class:"custom-container-title"},"提示",-1);function V(q,L){const i=r("RouterLink");return t(),o("div",null,[m,a("p",null,[e("默认的 Public 目录是 "),v,e(" ，可以通过 "),s(i,{to:"/DocVuepress/Java/reference/config.html#public"},{default:n(()=>[e("public")]),_:1}),e(" 配置项来修改。")]),p,a("p",null,[e("如果你的网站部署在非根路径下，例如 "),g,e(" ，那么你应该把 "),s(i,{to:"/DocVuepress/Java/reference/config.html#base"},{default:n(()=>[e("base")]),_:1}),e(" 设置为 "),b,e("。显然，此时你的 Public 文件会被部署在 "),h,e(" 这样的链接下。")]),_,a("p",null,[e("然而，有些情况下，你可能会有一些指向 Public 文件的动态路径，尤其是在你开发一个自定义主题的时候。在这种情况下， "),f,e(" 无法被自动处理。为了解决这个问题，VuePress 提供了 "),s(i,{to:"/DocVuepress/Java/reference/client-api.html#withbase"},{default:n(()=>[e("withBase")]),_:1}),e(" 工具函数，它可以帮助你添加 "),w,e(" 前缀：")]),k,a("div",x,[P,a("p",null,[e("配置参考： "),s(i,{to:"/DocVuepress/Java/reference/plugin-api.html#alias"},{default:n(()=>[e("alias")]),_:1})])])])}const D=l(u,[["render",V],["__file","assets.html.vue"]]);export{D as default};
