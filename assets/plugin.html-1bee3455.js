...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,1),q=n("code",null,"name",-1),y=n("code",null,"vuepress-plugin-xxx",-1),N=n("code",null,"@org/vuepress-plugin-xxx",-1),j=n("em",null,"插件对象",-1),J=n("li",null,[e("在 "),n("code",null,"keywords"),e(" 中包含 "),n("code",null,"vuepress-plugin"),e(" ，这样用户可以在 NPM 上搜索到你的插件。")],-1);function V(w,L){const s=d("RouterLink"),t=d("ExternalLinkIcon");return c(),o("div",null,[v,n("div",m,[p,n("p",null,[e("在阅读该指南之前，你最好先了解一下 VuePress 的 "),i(s,{to:"/Java/advanced/architecture.html"},{default:l(()=>[e("架构")]),_:1}),e(" 。")])]),_,n("p",null,[e("插件是一个符合 "),i(s,{to:"/Java/reference/plugin-api.html"},{default:l(()=>[e("插件 API")]),_:1}),e(" 的普通 JavaScript 对象，称之为 "),b,e(" ：")]),h,n("p",null,[e("插件还可以是一个接收 "),i(s,{to:"/Java/reference/node-api.html#app"},{default:l(()=>[e("App 实例")]),_:1}),e(" 作为参数，且返回值为 "),g,e(" 的函数，称之为 "),f,e(" ：")]),x,n("p",null,[e("在创建了插件之后，你需要在 "),n("a",k,[e("package.json"),i(t)]),e(" 文件中遵循一定的约定，然后再将其发布到 NPM 上：")]),P,n("ul",null,[n("li",null,[e("将 "),q,e(" 按照约定命名，即 "),y,e(" 或 "),N,e(" ，它应该和 "),j,e(" 的 "),i(s,{to:"/Java/reference/plugin-api.html#name"},{default:l(()=>[e("name")]),_:1}),e(" 字段保持一致。")]),J])])}const E=r(u,[["render",V],["__file","plugin.html.vue"]]);export{E as default};
