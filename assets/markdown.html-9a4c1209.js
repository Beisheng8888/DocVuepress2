import{_ as r,r as d,o as u,c as m,a as n,b as e,w as s,d as i,e as t}from"./app-f9425452.js";const v={},p=e("h1",{id:"markdown",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#markdown","aria-hidden":"true"},"#"),i(" Markdown")],-1),b=e("h2",{id:"自定义容器",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#自定义容器","aria-hidden":"true"},"#"),i(" 自定义容器")],-1),g=t(`<p>使用：</p><div class="language-markdown line-numbers-mode" data-ext="md"><pre class="language-markdown"><code>::: &lt;type&gt; [title]
[content]
:::
...
`)]),e("div",{class:"line-numbers","aria-hidden":"true"},[e("div",{class:"line-number"})])],-1);function G(N,O){const o=d("NpmBadge"),l=d("RouterLink"),a=d("CodeGroupItem"),c=d("CodeGroup");return u(),m("div",null,[p,n(o,{package:"@vuepress/theme-default"}),b,e("ul",null,[e("li",null,[g,e("ul",null,[_,h,f,k,e("li",null,[n(l,{to:"/Java/reference/default-theme/components.html#codegroup"},{default:s(()=>[i("CodeGroup")]),_:1}),i(" 和 "),n(l,{to:"/Java/reference/default-theme/components.html#codegroupitem"},{default:s(()=>[i("CodeGroupItem")]),_:1}),i(" 的别名： "),w])])]),x]),y,n(c,null,{default:s(()=>[n(a,{title:"FOO"},{default:s(()=>[C]),_:1}),n(a,{title:"BAR"},{default:s(()=>[B]),_:1})]),_:1})])}const P=r(v,[["render",G],["__file","markdown.html.vue"]]);export{P as default};
