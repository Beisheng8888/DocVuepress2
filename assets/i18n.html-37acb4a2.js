import{_ as a,r as c,o as t,c as r,b as n,d as e,a as s,w as d,e as l}from"./app-6ea6c10f.js";const v={},o=l(`<h1 id="多语言支持" tabindex="-1"><a class="header-anchor" href="#多语言支持" aria-hidden="true">#</a> 多语言支持</h1><h2 id="站点多语言配置" tabindex="-1"><a class="header-anchor" href="#站点多语言配置" aria-hidden="true">#</a> 站点多语言配置</h2><p>要启用 VuePress 的多语言支持，首先需要使用如下的文件目录结构：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>docs
├─ README.md
├─ foo.md
├─ nested
│  └─ README.md
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,4),_={class:"custom-container tip"},f=n("p",{class:"custom-container-title"},"提示",-1);function g(x,E){const i=c("RouterLink");return t(),r("div",null,[o,n("p",null,[e("然后，在你的 "),s(i,{to:"/DocVuepress/Java/guide/configuration.html#%E9%85%8D%E7%BD%AE%E6%96%87%E4%BB%B6"},{default:d(()=>[e("配置文件")]),_:1}),e(" 中设置 "),u,e(" 选项：")]),m,n("div",b,[h,n("p",null,[e("配置参考： "),s(i,{to:"/DocVuepress/Java/reference/config.html#locales"},{default:d(()=>[e("locales")]),_:1})])]),p,n("div",_,[f,n("p",null,[e("配置参考： "),s(i,{to:"/DocVuepress/Java/reference/default-theme/config.html#locales"},{default:d(()=>[e("默认主题 > locales")]),_:1})])])])}const D=a(v,[["render",g],["__file","i18n.html.vue"]]);export{D as default};
