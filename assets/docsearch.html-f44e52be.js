...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="获取搜索索引" tabindex="-1"><a class="header-anchor" href="#获取搜索索引" aria-hidden="true">#</a> 获取搜索索引</h2>`,5),p={href:"https://docsearch.algolia.com/apply/",target:"_blank",rel:"noopener noreferrer"},_=e("a",{href:"#apikey"},"apiKey",-1),g=e("a",{href:"#indexname"},"indexName",-1),f={href:"https://docsearch.algolia.com/docs/run-your-own/",target:"_blank",rel:"noopener noreferrer"},x=e("a",{href:"#appId"},"appId",-1),y=e("a",{href:"#apikey"},"apiKey",-1),D=e("a",{href:"#indexname"},"indexName",-1),S=r(`<details class="custom-container details"><summary>官方爬虫配置示例</summary><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code>new Crawler({
  appId: &#39;YOUR_APP_ID&#39;,
  apiKey: &#39;YOUR_API_KEY&#39;,
  rateLimit: 8,
  startUrls: [
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="组件" tabindex="-1"><a class="header-anchor" href="#组件" aria-hidden="true">#</a> 组件</h2><h3 id="docsearch-1" tabindex="-1"><a class="header-anchor" href="#docsearch-1" aria-hidden="true">#</a> Docsearch</h3><ul><li><p>详情：</p><p>该插件会全局注册一个 <code>&lt;Docsearch /&gt;</code> 组件，你可以不传入任何 Props 来使用它。</p><p>将该组件放置在你想要显示 docsearch 按钮的地方。例如，默认主题将这个组件放在了导航栏的末尾。</p></li></ul><div class="custom-container tip"><p class="custom-container-title">提示</p><p>该组件主要用于主题开发。在大多数情况下你不需要直接使用该组件。</p></div>`,5);function Re(Ae,Oe){const c=d("NpmBadge"),l=d("ExternalLinkIcon"),s=d("RouterLink");return t(),u("div",null,[h,n(c,{package:"@vuepress/plugin-docsearch"}),e("p",null,[i("将 "),e("a",b,[i("Algolia DocSearch"),n(l)]),i(" 集成到 VuePress 中，为你的文档网站提供搜索功能。")]),m,e("p",null,[i("你需要 "),e("a",p,[i("提交你的网站 URL"),n(l)]),i(" 来加入 DocSearch 项目。当你的索引成功创建后， DocSearch 团队会将 "),_,i(" 和 "),g,i(" 发送到你的邮箱。接下来，你就可以配置该插件，在 VuePress 中启用 DocSearch 了。")]),e("p",null,[i("或者，你也可以 "),e("a",f,[i("运行你自己的爬虫"),n(l)]),i(" 来创建索引，然后使用你自己的 "),x,i(", "),y,i(" 和 "),D,i(" 来配置该插件。")]),S,e("div",k,[P,e("p",null,[i("如果你使用的不是默认主题，或者在使用 Docsearch 的时候遇到了任何问题，你也可以检查上述的爬虫配置示例，然后前往 "),e("a",I,[i("Algolia Crawler"),n(l)]),i(" 仓库，在你项目侧边栏中的 Editor 页面中修改你的配置。")])]),E,w,e("ul",null,[N,R,A,e("li",null,[O,e("ul",null,[e("li",null,[e("a",T,[i("DocSearch > Options > apiKey"),n(l)])])])])]),U,e("ul",null,[B,L,V,e("li",null,[Y,e("ul",null,[e("li",null,[e("a",C,[i("DocSearch > Options > indexName"),n(l)])])])])]),K,e("ul",null,[z,W,j,e("li",null,[F,e("ul",null,[e("li",null,[e("a",M,[i("DocSearch > Options > appId"),n(l)])])])])]),q,e("ul",null,[J,X,e("li",null,[H,e("ul",null,[e("li",null,[e("a",Q,[i("DocSearch > Options > searchParameters"),n(l)])]),e("li",null,[e("a",$,[i("Algolia > Search API Parameters"),n(l)])])])])]),G,e("ul",null,[Z,ee,ie,e("li",null,[ne,e("ul",null,[e("li",null,[e("a",le,[i("DocSearch > Options > placeholder"),n(l)])])])])]),re,e("ul",null,[se,ae,de,e("li",null,[ce,e("ul",null,[e("li",null,[e("a",oe,[i("DocSearch > Options > disableUserPersonalization"),n(l)])])])])]),te,e("ul",null,[ue,ve,e("li",null,[he,e("ul",null,[e("li",null,[e("a",be,[i("DocSearch > Options > initialQuery"),n(l)])])])])]),me,e("ul",null,[pe,_e,e("li",null,[ge,e("ul",null,[e("li",null,[e("a",fe,[i("DocSearch > Options > translations"),n(l)])])])])]),xe,e("ul",null,[e("li",null,[i("参考： "),e("ul",null,[e("li",null,[n(s,{to:"/DocVuepress/Java/guide/i18n.html"},{default:a(()=>[i("指南 > 多语言支持")]),_:1})])])])]),ye,e("ul",null,[De,e("li",null,[e("p",null,[i("默认值： "),n(s,{to:"/DocVuepress/Java/reference/config.html#base"},{default:a(()=>[i("base")]),_:1})])]),e("li",null,[Se,ke,Pe,e("p",null,[i("如果你不同部署域名下的 "),n(s,{to:"/DocVuepress/Java/reference/config.html#base"},{default:a(()=>[i("base")]),_:1}),i(" 是不一样的，你就需要将这个配置设置成 "),Ie,i(" 的 "),n(s,{to:"/DocVuepress/Java/reference/config.html#base"},{default:a(()=>[i("base")]),_:1}),i(" ，这样其他的部署域名就可以正确复用索引了。")])])]),Ee,e("p",null,[i("你可以通过 "),e("a",we,[i("@docsearch/css"),n(l)]),i(" 提供的 CSS 变量来自定义样式：")]),Ne])}const Ue=o(v,[["render",Re],["__file","docsearch.html.vue"]]);export{Ue as default};
