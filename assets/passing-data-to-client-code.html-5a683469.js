...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,5);function f(h,g){const n=r("RouterLink");return o(),l("div",null,[p,u,v,i("p",null,[e("插件 API 提供了一个 "),s(n,{to:"/DocVuepress/Java/reference/plugin-api.html#define"},{default:d(()=>[e("define")]),_:1}),e(" Hook 来定义客户端代码中的全局常量。你可以利用它来向客户端传递数据。")]),m,i("p",null,[e("首先，写入一个名为 "),_,e(" 的临时文件，它将会生成在 "),s(n,{to:"/DocVuepress/Java/reference/config.html#temp"},{default:d(()=>[e("temp")]),_:1}),e(" 目录中：")]),b])}const y=t(c,[["render",f],["__file","passing-data-to-client-code.html.vue"]]);export{y as default};
