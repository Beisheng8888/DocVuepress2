import{_ as a,r as s,o as r,c as t,a as n,b as e,d as i,e as d}from"./app-c48a9718.js";const c={},u=e("h1",{id:"medium-zoom",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#medium-zoom","aria-hidden":"true"},"#"),i(" medium-zoom")],-1),m={href:"https://github.com/francoischalifour/medium-zoom#readme",target:"_blank",rel:"noopener noreferrer"},h=d(`<p>该插件已经集成到默认主题中。</p><h2 id="使用方法" tabindex="-1"><a class="header-anchor" href="#使用方法" aria-hidden="true">#</a> 使用方法</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>npm i -D @vuepress/plugin-medium-zoom@next
