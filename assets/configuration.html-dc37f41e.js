...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,3),m={class:"custom-container tip"},g=s("p",{class:"custom-container-title"},"提示",-1),b=c(`<h2 id="客户端配置文件" tabindex="-1"><a class="header-anchor" href="#客户端配置文件" aria-hidden="true">#</a> 客户端配置文件</h2><p>在大多数情况下，配置文件已经足够帮助你配置好你的 VuePress 站点。不过，有些时候用户们可能希望直接添加一些客户端代码。 VuePress 通过客户端配置文件来支持这种需求：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>├─ docs
│  ├─ .vuepress
│  │  ├─ client.js   &lt;--- 客户端配置文件
│  │  └─ config.js   &lt;--- 配置文件
│  └─ README.md
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,7),f={class:"custom-container tip"},h=s("p",{class:"custom-container-title"},"提示",-1),_=s("p",null,"和配置文件不同，客户端配置文件不能通过命令行接口的选项来指定。",-1);function x(j,V){const i=o("RouterLink");return a(),r("div",null,[u,s("p",null,[e("你也可以通过 "),n(i,{to:"/DocVuepress/Java/reference/cli.html"},{default:d(()=>[e("命令行接口")]),_:1}),e(" 的 "),v,e(" 选项来指定配置文件：")]),p,s("div",m,[g,s("p",null,[e("前往 "),n(i,{to:"/DocVuepress/Java/reference/config.html"},{default:d(()=>[e("配置参考")]),_:1}),e(" 查看所有 VuePress 配置。")])]),b,s("div",f,[h,_,s("p",null,[e("可以前往 "),n(i,{to:"/DocVuepress/Java/advanced/cookbook/usage-of-client-config.html"},{default:d(()=>[e("深入 > Cookbook > 客户端配置的使用方法")]),_:1}),e(" 来了解更多信息。")])])])}const k=l(t,[["render",x],["__file","configuration.html.vue"]]);export{k as default};
