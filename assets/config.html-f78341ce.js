...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="repolabel" tabindex="-1"><a class="header-anchor" href="#repolabel" aria-hidden="true">#</a> repoLabel</h3><ul><li><p>类型： <code>string</code></p></li><li><p>详情：</p><p>项目仓库的标签。</p><p>它将被用作 <em>仓库链接</em> 的文字。<em>仓库链接</em> 将会显示为导航栏的最后一个元素。</p><p>如果你不明确指定该配置项，它将会根据 <a href="#repo">repo</a> 配置项自动推断。</p></li></ul><h3 id="selectlanguagetext" tabindex="-1"><a class="header-anchor" href="#selectlanguagetext" aria-hidden="true">#</a> selectLanguageText</h3>`,8),J=e("li",null,[e("p",null,[l("类型： "),e("code",null,"string")])],-1),R=e("p",null,"详情：",-1),I=e("p",null,[e("em",null,"选择语言菜单"),l(" 的文字。")],-1),P=e("em",null,"选择语言菜单",-1),G=a(`<h3 id="selectlanguagearialabel" tabindex="-1"><a class="header-anchor" href="#selectlanguagearialabel" aria-hidden="true">#</a> selectLanguageAriaLabel</h3><ul><li><p>类型： <code>string</code></p></li><li><p>详情：</p><p><em>选择语言菜单</em> 的 <code>aria-label</code> 属性。</p><p>它主要是为了站点的可访问性 (a11y) 。</p></li></ul><h3 id="selectlanguagename" tabindex="-1"><a class="header-anchor" href="#selectlanguagename" aria-hidden="true">#</a> selectLanguageName</h3><ul><li><p>类型： <code>string</code></p></li><li><p>详情：</p><p>Locale 的语言名称。</p><p>该配置项 <strong>仅能在主题配置的 <a href="#locales">locales</a> 的内部生效</strong> 。它将被用作 locale 的语言名称，展示在 <em>选择语言菜单</em> 内。</p></li><li><p>示例：</p></li></ul><div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code>export default {
  locales: {
    &#39;/&#39;: {
      lang: &#39;en-US&#39;,
    },
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="sidebar" tabindex="-1"><a class="header-anchor" href="#sidebar" aria-hidden="true">#</a> sidebar</h3>`,6),S=e("li",null,[e("p",null,[l("类型： "),e("code",null,"false | 'auto' | SidebarConfigArray | SidebarConfigObject")])],-1),M=e("li",null,[e("p",null,[l("默认值： "),e("code",null,"'auto'")])],-1),U=e("p",null,"详情：",-1),C=e("p",null,"侧边栏配置。",-1),z=a("<p>设置为 <code>false</code> 可以禁用侧边栏。</p><p>如果你设置为 <code>&#39;auto&#39;</code>，侧边栏会根据页面标题自动生成。</p><p>为了手动配置侧边栏元素，你可以将其设置为 <em>侧边栏数组</em> ，其中的每个元素是一个 <code>SidebarItem</code> 对象或者一个字符串：</p><ul><li><code>SidebarItem</code> 对象应该有一个 <code>text</code> 字段，有一个可选的 <code>link</code> 字段、一个可选的 <code>children</code> 字段和一个可选的 <code>collapsible</code> 字段。 <code>children</code> 字段同样是一个 <em>侧边栏数组</em> 。 <code>collapsible</code> 字段来控制它是否可折叠。</li><li>字符串应为目标页面文件的路径。它将会被转换为 <code>SidebarItem</code> 对象，将页面标题作为 <code>text</code> ，将页面路由路径作为 <code>link</code> ，并根据页面小标题自动生成 <code>children</code> 。</li></ul><p>如果你想在不同子路径中使用不同的侧边栏，你可以将该配置项设置为 <em>侧边栏对象</em> ：</p><ul><li>Key 为路径前缀。</li><li>Value 为 <em>侧边栏数组</em> 。</li></ul>",6),F=e("li",null,[e("p",null,"示例 1：")],-1),H=a(`<div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code>export default {
  theme: defaultTheme({
    // 侧边栏数组
    // 所有页面会使用相同的侧边栏
    sidebar: [
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>则会生成类似于 <code>&#39;https://gitlab.com/owner/name/-/edit/master/docs/path/to/file.md&#39;</code> 的链接。</p><h3 id="docsrepo" tabindex="-1"><a class="header-anchor" href="#docsrepo" aria-hidden="true">#</a> docsRepo</h3><ul><li><p>类型： <code>string</code></p></li><li><p>详情：</p><p>文档源文件的仓库 URL 。</p><p>它将会用于生成 <em>编辑此页</em> 的链接。</p><p>如果你不设置该选项，则默认会使用 <a href="#repo">repo</a> 配置项。但是如果你的文档源文件是在一个不同的仓库内，你就需要设置该配置项了。</p></li></ul><h3 id="docsbranch" tabindex="-1"><a class="header-anchor" href="#docsbranch" aria-hidden="true">#</a> docsBranch</h3><ul><li><p>类型： <code>string</code></p></li><li><p>默认值： <code>&#39;main&#39;</code></p></li><li><p>详情：</p><p>文档源文件的仓库分支。</p><p>它将会用于生成 <em>编辑此页</em> 的链接。</p></li></ul><h3 id="docsdir" tabindex="-1"><a class="header-anchor" href="#docsdir" aria-hidden="true">#</a> docsDir</h3><ul><li><p>类型： <code>string</code></p></li><li><p>默认值： <code>&#39;&#39;</code></p></li><li><p>详情：</p><p>文档源文件存放在仓库中的目录名。</p><p>它将会用于生成 <em>编辑此页</em> 的链接。</p></li></ul><h3 id="lastupdated" tabindex="-1"><a class="header-anchor" href="#lastupdated" aria-hidden="true">#</a> lastUpdated</h3>`,13),ee=e("li",null,[e("p",null,[l("类型： "),e("code",null,"boolean")])],-1),le=e("li",null,[e("p",null,[l("默认值： "),e("code",null,"true")])],-1),ie=e("p",null,"详情：",-1),ne=e("p",null,[l("是否启用 "),e("em",null,"最近更新时间戳"),l(" 。")],-1),de=e("code",null,"false",-1),ae=a('<h3 id="lastupdatedtext" tabindex="-1"><a class="header-anchor" href="#lastupdatedtext" aria-hidden="true">#</a> lastUpdatedText</h3><ul><li><p>类型： <code>string</code></p></li><li><p>默认值： <code>&#39;Last Updated&#39;</code></p></li><li><p>详情：</p><p><em>最近更新时间戳</em> 标签的文字。</p></li></ul><h3 id="contributors" tabindex="-1"><a class="header-anchor" href="#contributors" aria-hidden="true">#</a> contributors</h3>',3),se=e("li",null,[e("p",null,[l("类型： "),e("code",null,"boolean")])],-1),oe=e("li",null,[e("p",null,[l("默认值： "),e("code",null,"true")])],-1),te=e("p",null,"详情：",-1),re=e("p",null,[l("是否启用 "),e("em",null,"贡献者列表"),l(" 。")],-1),ce=e("code",null,"false",-1),ue=a('<h3 id="contributorstext" tabindex="-1"><a class="header-anchor" href="#contributorstext" aria-hidden="true">#</a> contributorsText</h3><ul><li><p>类型： <code>string</code></p></li><li><p>默认值： <code>&#39;Contributors&#39;</code></p></li><li><p>详情：</p><p><em>贡献者列表</em> 标签的文字。</p></li></ul><h3 id="tip" tabindex="-1"><a class="header-anchor" href="#tip" aria-hidden="true">#</a> tip</h3>',3),pe=e("li",null,[e("p",null,[l("类型： "),e("code",null,"string")])],-1),he=e("li",null,[e("p",null,[l("默认值： "),e("code",null,"'TIP'")])],-1),me=e("p",null,"详情：",-1),ve=e("h3",{id:"warning",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#warning","aria-hidden":"true"},"#"),l(" warning")],-1),be=e("li",null,[e("p",null,[l("类型： "),e("code",null,"string")])],-1),ge=e("li",null,[e("p",null,[l("默认值： "),e("code",null,"'WARNING'")])],-1),_e=e("p",null,"详情：",-1),fe=e("h3",{id:"danger",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#danger","aria-hidden":"true"},"#"),l(" danger")],-1),xe=e("li",null,[e("p",null,[l("类型： "),e("code",null,"string")])],-1),ke=e("li",null,[e("p",null,[l("默认值： "),e("code",null,"'DANGER'")])],-1),Ee=e("p",null,"详情：",-1),Le=a('<h3 id="notfound" tabindex="-1"><a class="header-anchor" href="#notfound" aria-hidden="true">#</a> notFound</h3><ul><li><p>类型： <code>string[]</code></p></li><li><p>默认值： <code>[&#39;Not Found&#39;]</code></p></li><li><p>详情：</p><p>404 页面的提示信息。</p><p>当用户进入 404 页面时，会从数组中随机选取一条信息进行展示。</p></li></ul><h3 id="backtohome" tabindex="-1"><a class="header-anchor" href="#backtohome" aria-hidden="true">#</a> backToHome</h3><ul><li><p>类型： <code>string</code></p></li><li><p>默认值： <code>&#39;Back to home&#39;</code></p></li><li><p>详情：</p><p>404 页面中 <em>返回首页</em> 链接的文字。</p></li></ul><h3 id="openinnewwindow" tabindex="-1"><a class="header-anchor" href="#openinnewwindow" aria-hidden="true">#</a> openInNewWindow</h3>',5),De=e("li",null,[e("p",null,[l("类型： "),e("code",null,"string")])],-1),we=e("li",null,[e("p",null,[l("默认值： "),e("code",null,"'open in new window'")])],-1),Ae=e("p",null,"详情：",-1),ye=e("code",null,"sr-only",-1),Ve=e("p",null,"它主要是为了站点的可访问性 (a11y) 。",-1),Ne=e("li",null,[e("p",null,"参考："),e("ul",null,[e("li",null,[e("a",{href:"#themeplugins-externallinkicon"},"默认主题 > 配置 > themePlugins.externalLinkIcon")])])],-1),Te=a('<h3 id="togglecolormode" tabindex="-1"><a class="header-anchor" href="#togglecolormode" aria-hidden="true">#</a> toggleColorMode</h3><ul><li><p>类型： <code>string</code></p></li><li><p>默认值： <code>&#39;toggle color mode&#39;</code></p></li><li><p>详情：</p><p>切换颜色模式按钮的标题文字。</p><p>它主要是为了站点的可访问性 (a11y) 。</p></li><li><p>参考：</p><ul><li><a href="#colormodeswitch">默认主题 &gt; 配置 &gt; colorModeSwitch</a></li></ul></li></ul><h3 id="togglesidebar" tabindex="-1"><a class="header-anchor" href="#togglesidebar" aria-hidden="true">#</a> toggleSidebar</h3><ul><li><p>类型： <code>string</code></p></li><li><p>默认值： <code>&#39;toggle sidebar&#39;</code></p></li><li><p>详情：</p><p>切换侧边栏按钮的标题文字。</p><p>它主要是为了站点的可访问性 (a11y) 。</p></li></ul><h2 id="插件配置" tabindex="-1"><a class="header-anchor" href="#插件配置" aria-hidden="true">#</a> 插件配置</h2><h3 id="themeplugins" tabindex="-1"><a class="header-anchor" href="#themeplugins" aria-hidden="true">#</a> themePlugins</h3><ul><li><p>详情：</p><p>设置默认主题使用的插件。</p><p>默认主题使用了一些插件，如果你确实不需要该插件，你可以选择禁用它。在禁用插件之前，请确保你已了解它的用途。</p></li></ul><h3 id="themeplugins-activeheaderlinks" tabindex="-1"><a class="header-anchor" href="#themeplugins-activeheaderlinks" aria-hidden="true">#</a> themePlugins.activeHeaderLinks</h3>',8),Be=e("li",null,[e("p",null,[l("类型： "),e("code",null,"boolean")])],-1),Je=e("li",null,[e("p",null,[l("默认值： "),e("code",null,"true")])],-1),Re=e("p",null,"详情：",-1),Ie=e("h4",{id:"themeplugins-backtotop",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#themeplugins-backtotop","aria-hidden":"true"},"#"),l(" themePlugins.backToTop")],-1),Pe=e("li",null,[e("p",null,[l("类型： "),e("code",null,"boolean")])],-1),Ge=e("li",null,[e("p",null,[l("默认值： "),e("code",null,"true")])],-1),Se=e("p",null,"详情：",-1),Me=e("h3",{id:"themeplugins-container",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#themeplugins-container","aria-hidden":"true"},"#"),l(" themePlugins.container")],-1),Ue=e("li",null,[e("p",null,[l("类型： "),e("code",null,"Record<ContainerType, boolean>")])],-1),Ce=e("p",null,"详情：",-1),ze=a("<p><code>ContainerType</code> 类型为：</p><ul><li><code>tip</code></li><li><code>warning</code></li><li><code>danger</code></li><li><code>details</code></li><li><code>codeGroup</code></li><li><code>codeGroupItem</code></li></ul>",2),Fe=e("p",null,"参考：",-1),He=e("h3",{id:"themeplugins-externallinkicon",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#themeplugins-externallinkicon","aria-hidden":"true"},"#"),l(" themePlugins.externalLinkIcon")],-1),We=e("li",null,[e("p",null,[l("类型： "),e("code",null,"boolean")])],-1),je=e("li",null,[e("p",null,[l("默认值： "),e("code",null,"true")])],-1),Ke=e("p",null,"详情：",-1),Oe=e("h3",{id:"themeplugins-git",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#themeplugins-git","aria-hidden":"true"},"#"),l(" themePlugins.git")],-1),Ze=e("li",null,[e("p",null,[l("类型： "),e("code",null,"boolean")])],-1),qe=e("li",null,[e("p",null,[l("默认值： "),e("code",null,"true")])],-1),Qe=e("p",null,"详情：",-1),Xe=e("h3",{id:"themeplugins-mediumzoom",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#themeplugins-mediumzoom","aria-hidden":"true"},"#"),l(" themePlugins.mediumZoom")],-1),Ye=e("li",null,[e("p",null,[l("类型： "),e("code",null,"boolean")])],-1),$e=e("li",null,[e("p",null,[l("默认值： "),e("code",null,"true")])],-1),el=e("p",null,"详情：",-1),ll=e("h3",{id:"themeplugins-nprogress",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#themeplugins-nprogress","aria-hidden":"true"},"#"),l(" themePlugins.nprogress")],-1),il=e("li",null,[e("p",null,[l("类型： "),e("code",null,"boolean")])],-1),nl=e("li",null,[e("p",null,[l("默认值： "),e("code",null,"true")])],-1),dl=e("p",null,"详情：",-1);function al(sl,ol){const o=s("NpmBadge"),n=s("RouterLink"),t=s("ExternalLinkIcon");return c(),u("div",null,[h,i(o,{package:"@vuepress/theme-default"}),m,e("ul",null,[v,b,e("li",null,[g,_,f,e("p",null,[l("该配置项仅能在默认主题内生效，注意不要和 "),i(n,{to:"/DocVuepress/Java/reference/config.html#locales"},{default:d(()=>[l("站点配置")]),_:1}),l(" 中的 "),x,l(" 混淆。")])]),e("li",null,[k,e("ul",null,[e("li",null,[i(n,{to:"/DocVuepress/Java/guide/i18n.html"},{default:d(()=>[l("指南 > 多语言支持")]),_:1})])])])]),E,e("ul",null,[L,D,e("li",null,[w,A,e("p",null,[l("如果设置为 "),y,l(" ，则会根据 "),e("a",V,[l("prefers-color-scheme"),i(t)]),l(" 自动设置初始颜色模式。")])]),N]),T,e("ul",null,[e("li",null,[l("参考： "),e("ul",null,[e("li",null,[i(n,{to:"/DocVuepress/Java/guide/assets.html#public-%E6%96%87%E4%BB%B6"},{default:d(()=>[l("指南 > 静态资源 > Public 文件")]),_:1})])])])]),B,e("ul",null,[J,e("li",null,[R,I,e("p",null,[l("如果你在站点配置中设置了多个 "),i(n,{to:"/DocVuepress/Java/reference/config.html#locales"},{default:d(()=>[l("locales")]),_:1}),l(" ，那么 "),P,l(" 就会显示在导航栏中仓库按钮的旁边。")])])]),G,e("ul",null,[S,M,e("li",null,[U,C,e("p",null,[l("你可以通过页面的 "),i(n,{to:"/DocVuepress/Java/reference/default-theme/frontmatter.html#sidebar"},{default:d(()=>[l("sidebar")]),_:1}),l(" frontmatter 来覆盖这个全局配置。")]),z]),F]),H,e("ul",null,[W,j,e("li",null,[K,e("p",null,[l("最大值取决于你通过 "),i(n,{to:"/DocVuepress/Java/reference/config.html#markdown-headers"},{default:d(()=>[l("markdown.headers.level")]),_:1}),l(" 提取了哪些级别的标题。")]),O,e("p",null,[l("你可以通过页面的 "),i(n,{to:"/DocVuepress/Java/reference/default-theme/frontmatter.html#sidebardepth"},{default:d(()=>[l("sidebarDepth")]),_:1}),l(" frontmatter 来覆盖这个全局配置。")])])]),Z,e("ul",null,[q,Q,e("li",null,[X,Y,e("p",null,[l("你可以通过页面的 "),i(n,{to:"/DocVuepress/Java/reference/default-theme/frontmatter.html#editlink"},{default:d(()=>[l("editLink")]),_:1}),l(" frontmatter 来覆盖这个全局配置。")])])]),$,e("ul",null,[ee,le,e("li",null,[ie,ne,e("p",null,[l("你可以通过页面的 "),i(n,{to:"/DocVuepress/Java/reference/default-theme/frontmatter.html#lastupdated"},{default:d(()=>[l("lastUpdated")]),_:1}),l(" frontmatter 来覆盖这个全局配置。要注意的是，如果你已经将该选项设为了 "),de,l(" ，那么这个功能会被完全禁用，并且无法在 locales 或页面 frontmatter 中启用。")])])]),ae,e("ul",null,[se,oe,e("li",null,[te,re,e("p",null,[l("你可以通过页面的 "),i(n,{to:"/DocVuepress/Java/reference/default-theme/frontmatter.html#contributors"},{default:d(()=>[l("contributors")]),_:1}),l(" frontmatter 来覆盖这个全局配置。要注意的是，如果你已经将该选项设为了 "),ce,l(" ，那么这个功能会被完全禁用，并且无法在 locales 或页面 frontmatter 中启用。")])])]),ue,e("ul",null,[pe,he,e("li",null,[me,e("p",null,[l("Tip "),i(n,{to:"/DocVuepress/Java/reference/default-theme/markdown.html#%E8%87%AA%E5%AE%9A%E4%B9%89%E5%AE%B9%E5%99%A8"},{default:d(()=>[l("自定义容器")]),_:1}),l(" 的默认标题。")])])]),ve,e("ul",null,[be,ge,e("li",null,[_e,e("p",null,[l("Warning "),i(n,{to:"/DocVuepress/Java/reference/default-theme/markdown.html#%E8%87%AA%E5%AE%9A%E4%B9%89%E5%AE%B9%E5%99%A8"},{default:d(()=>[l("自定义容器")]),_:1}),l(" 的默认标题。")])])]),fe,e("ul",null,[xe,ke,e("li",null,[Ee,e("p",null,[l("Danger "),i(n,{to:"/DocVuepress/Java/reference/default-theme/markdown.html#%E8%87%AA%E5%AE%9A%E4%B9%89%E5%AE%B9%E5%99%A8"},{default:d(()=>[l("自定义容器")]),_:1}),l(" 的默认标题。")])])]),Le,e("ul",null,[De,we,e("li",null,[Ae,e("p",null,[i(n,{to:"/DocVuepress/Java/reference/plugin/external-link-icon.html#externallinkicon"},{default:d(()=>[l("ExternalLinkIcon")]),_:1}),l(". 链接内的 "),ye,l(" 文字。")]),Ve]),Ne]),Te,e("ul",null,[Be,Je,e("li",null,[Re,e("p",null,[l("是否启用 "),i(n,{to:"/DocVuepress/Java/reference/plugin/active-header-links.html"},{default:d(()=>[l("@vuepress/plugin-active-header-links")]),_:1}),l(" 。")])])]),Ie,e("ul",null,[Pe,Ge,e("li",null,[Se,e("p",null,[l("是否启用 "),i(n,{to:"/DocVuepress/Java/reference/plugin/back-to-top.html"},{default:d(()=>[l("@vuepress/plugin-back-to-top")]),_:1}),l(" 。")])])]),Me,e("ul",null,[Ue,e("li",null,[Ce,e("p",null,[l("是否启用由 "),i(n,{to:"/DocVuepress/Java/reference/plugin/container.html"},{default:d(()=>[l("@vuepress/plugin-container")]),_:1}),l(" 支持的自定义容器。")]),ze]),e("li",null,[Fe,e("ul",null,[e("li",null,[i(n,{to:"/DocVuepress/Java/reference/default-theme/markdown.html#%E8%87%AA%E5%AE%9A%E4%B9%89%E5%AE%B9%E5%99%A8"},{default:d(()=>[l("默认主题 > Markdown > 自定义容器")]),_:1})])])])]),He,e("ul",null,[We,je,e("li",null,[Ke,e("p",null,[l("是否启用 "),i(n,{to:"/DocVuepress/Java/reference/plugin/external-link-icon.html"},{default:d(()=>[l("@vuepress/plugin-external-link-icon")]),_:1}),l(" 。")])])]),Oe,e("ul",null,[Ze,qe,e("li",null,[Qe,e("p",null,[l("是否启用 "),i(n,{to:"/DocVuepress/Java/reference/plugin/git.html"},{default:d(()=>[l("@vuepress/plugin-git")]),_:1}),l(" 。")])])]),Xe,e("ul",null,[Ye,$e,e("li",null,[el,e("p",null,[l("是否启用 "),i(n,{to:"/DocVuepress/Java/reference/plugin/medium-zoom.html"},{default:d(()=>[l("@vuepress/plugin-medium-zoom")]),_:1}),l(" 。")])])]),ll,e("ul",null,[il,nl,e("li",null,[dl,e("p",null,[l("是否启用 "),i(n,{to:"/DocVuepress/Java/reference/plugin/nprogress.html"},{default:d(()=>[l("@vuepress/plugin-nprogress")]),_:1}),l(" 。")])])])])}const rl=r(p,[["render",al],["__file","config.html.vue"]]);export{rl as default};
