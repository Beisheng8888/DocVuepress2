...
&lt;template&gt;
  ...
  &lt;/div&gt;
&lt;/template&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这样，用户在继承或使用你的主题时，就可以通过覆盖 <code>alias</code> 来替换特定的组件了。</p>`,11);function p(b,h){const i=l("RouterLink");return d(),r("div",null,[c,m,n("p",null,[e("借助于 "),a(i,{to:"/DocVuepress/Java/reference/theme-api.html"},{default:s(()=>[e("主题 API")]),_:1}),e(" ，你可以让用户继承你的主题，允许用户对你的主题进行改动。")]),n("p",null,[e("你肯定已经知道了如何 "),a(i,{to:"/DocVuepress/Java/reference/default-theme/extending.html"},{default:s(()=>[e("继承默认主题")]),_:1}),e(" 。接下来我们将介绍如何让你的主题像默认主题一样被用户继承。")]),o])}const _=t(u,[["render",p],["__file","making-a-theme-extendable.html.vue"]]);export{_ as default};
