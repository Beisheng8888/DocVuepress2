...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ol start="3"><li>在执行了 <code>pnpm docs:build</code> 后, 使用 <code>firebase deploy</code> 指令来部署。</li></ol>`,5),L={class:"custom-container tip"},U=e("p",{class:"custom-container-title"},"提示",-1),D={href:"https://firebase.google.com/docs/cli",target:"_blank",rel:"noopener noreferrer"},M=e("h2",{id:"heroku",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#heroku","aria-hidden":"true"},"#"),n(" Heroku")],-1),T={href:"https://devcenter.heroku.com/articles/heroku-cli",target:"_blank",rel:"noopener noreferrer"},F={href:"https://signup.heroku.com",target:"_blank",rel:"noopener noreferrer"},K=e("li",null,[e("p",null,[n("运行 "),e("code",null,"heroku login"),n(" 并填写你的 Heroku 认证信息：")])],-1),z=l(`<div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>heroku login
