...
Options:
  ...
  -v, --version          Display version number 
  -h, --help             Display this message
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="custom-container tip"><p class="custom-container-title">提示</p><p>通过命令行设置的配置项，会覆盖你配置文件中的同名配置项。</p></div><h2 id="info" tabindex="-1"><a class="header-anchor" href="#info" aria-hidden="true">#</a> info</h2><p>输出当前系统和依赖相关的信息。</p><p>在你想要检查你的环境，或者提交 Issue 时候，可以使用该命令。</p>`,5);function D(k,S){const d=a("NpmBadge"),s=a("ExternalLinkIcon"),r=a("RouterLink");return c(),o("div",null,[p,n(d,{package:"@vuepress/cli"}),i("p",null,[e("VuePress 命令行接口是由 "),i("a",m,[e("@vuepress/cli"),n(s)]),e(" 包提供的。它包含在 "),i("a",h,[e("vuepress"),n(s)]),e(" 包之中，当然你也可以单独安装它。")]),b,i("div",f,[g,i("p",null,[e("VuePress 使用了 "),i("a",_,[e("debug"),n(s)]),e(" 模块。")]),y]),w,i("p",null,[e("将你的 VuePress 站点构建成静态文件，以便你进行后续"),n(r,{to:"/DocVuepress/Java/guide/deployment.html"},{default:v(()=>[e("部署")]),_:1}),e("。")]),x])}const B=t(u,[["render",D],["__file","cli.html.vue"]]);export{B as default};
