import{_ as c,r as i,o as t,c as o,a,b as e,d as n,w as u,e as l}from"./app-5f243ec2.js";const p={},v=e("h1",{id:"external-link-icon",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#external-link-icon","aria-hidden":"true"},"#"),n(" external-link-icon")],-1),h=l(`<p>该插件已经集成到默认主题中。</p><h2 id="使用方法" tabindex="-1"><a class="header-anchor" href="#使用方法" aria-hidden="true">#</a> 使用方法</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>npm i -D @vuepress/plugin-external-link-icon@next
