import{_ as d,r as i,o as t,c as o,a as s,b as e,d as n,e as a}from"./app-5f243ec2.js";const c={},p=e("h1",{id:"register-components",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#register-components","aria-hidden":"true"},"#"),n(" register-components")],-1),m=a(`<p>根据组件文件或目录自动注册 Vue 组件。</p><h2 id="使用方法" tabindex="-1"><a class="header-anchor" href="#使用方法" aria-hidden="true">#</a> 使用方法</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>npm i -D @vuepress/plugin-register-components@next
