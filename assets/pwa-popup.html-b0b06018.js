...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,8),g=d('<h2 id="样式" tabindex="-1"><a class="header-anchor" href="#样式" aria-hidden="true">#</a> 样式</h2><p>你可以通过 CSS 变量来自定义弹窗的样式：</p><div class="language-css line-numbers-mode" data-ext="css"><pre class="language-css"><code>File not found</code></pre><div class="line-numbers" aria-hidden="true"></div></div>',3);function _(f,w){const r=s("NpmBadge"),a=s("RouterLink");return c(),p("div",null,[o,n(r,{package:"@vuepress/plugin-pwa-popup"}),v,e("p",null,[i("该插件必须和 "),n(a,{to:"/DocVuepress/Java/reference/plugin/pwa.html"},{default:l(()=>[i("pwa 插件")]),_:1}),i(" 一起使用，并且 "),m,i(" 配置项不能设置为 "),h,i(" 。")]),b,e("ul",null,[e("li",null,[i("参考： "),e("ul",null,[e("li",null,[n(a,{to:"/DocVuepress/Java/guide/i18n.html"},{default:l(()=>[i("指南 > 多语言支持")]),_:1})])])])]),g])}const P=u(t,[["render",_],["__file","pwa-popup.html.vue"]]);export{P as default};
