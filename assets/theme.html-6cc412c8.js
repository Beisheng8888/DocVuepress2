import{_ as r,r as t,o,c,b as n,d as e,a as i,w as l,e as d}from"./app-f9425452.js";const v={},u=n("h1",{id:"开发主题",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#开发主题","aria-hidden":"true"},"#"),e(" 开发主题")],-1),m={class:"custom-container tip"},p=n("p",{class:"custom-container-title"},"提示",-1),b=n("h2",{id:"创建一个主题",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#创建一个主题","aria-hidden":"true"},"#"),e(" 创建一个主题")],-1),h=n("em",null,"主题对象",-1),_=n("em",null,"主题函数",-1),g=d(`<div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code>import { getDirname, path } from &#39;@vuepress/utils&#39;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,1),C=n("code",null,"name",-1),L=n("code",null,"vuepress-theme-xxx",-1),j=n("code",null,"@org/vuepress-theme-xxx",-1),q=n("em",null,"主题对象",-1),F=n("li",null,[e("在 "),n("code",null,"keywords"),e(" 中包含 "),n("code",null,"vuepress-theme"),e(" ，这样用户可以在 NPM 上搜索到你的主题。")],-1);function w(J,P){const s=t("RouterLink"),a=t("ExternalLinkIcon");return o(),c("div",null,[u,n("div",m,[p,n("p",null,[e("在阅读该指南之前，你最好先了解一下 "),i(s,{to:"/Java/advanced/plugin.html"},{default:l(()=>[e("开发插件")]),_:1}),e(" 指南。")])]),b,n("p",null,[e("VuePress 主题是一个特殊的插件，它应该符合 "),i(s,{to:"/Java/reference/theme-api.html"},{default:l(()=>[e("主题 API")]),_:1}),e(" 。和插件一样，主题可以是一个 "),h,e(" 或一个 "),_,e(" ，并且通常通过一个函数来接收配置项：")]),g,n("p",null,[f,e(" 布局应该包含 "),i(s,{to:"/Java/reference/components.html#content"},{default:l(()=>[e("Content")]),_:1}),e(" 组件来展示 Markdown 内容：")]),x,n("p",null,[e("你可以提供多个布局，用户可以通过 "),i(s,{to:"/Java/reference/frontmatter.html#layout"},{default:l(()=>[e("layout")]),_:1}),e(" Frontmatter 来修改布局。")]),y,n("p",null,[e("同样的，对于主题也有 "),n("a",k,[e("package.json"),i(a)]),e(" 相关的约定：")]),N,n("ul",null,[n("li",null,[e("将 "),C,e(" 按照约定命名： "),L,e(" 或 "),j,e(" ，它应该和 "),q,e(" 的 "),i(s,{to:"/Java/reference/theme-api.html#name"},{default:l(()=>[e("name")]),_:1}),e(" 字段保持一致。")]),F])])}const B=r(v,[["render",w],["__file","theme.html.vue"]]);export{B as default};
