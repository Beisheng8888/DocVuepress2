...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,5),V=d(`<h3 id="extendspage" tabindex="-1"><a class="header-anchor" href="#extendspage" aria-hidden="true">#</a> extendsPage</h3><ul><li><p>类型： <code>(page: Page, app: App) =&gt; void | Promise&lt;void&gt;</code></p></li><li><p>详情：</p><p>页面扩展。</p><p>该 Hook 接收一个函数，在参数中会收到一个 <code>Page</code> 实例。</p><p>该 Hook 可以用来在 Page 对象上添加额外的属性，或修改现有的属性等。</p><p>值得一提的是，针对 <code>page.data</code> 和 <code>page.routeMeta</code> 的改动可以在客户端代码中使用。</p></li><li><p>示例：</p></li></ul><div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code>export default {
  extendsPage: (page) =&gt; {
    page.foo = &#39;foo&#39;
    page.data.bar = &#39;bar&#39;
  },
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,5),C=d('<h2 id="生命周期-hooks" tabindex="-1"><a class="header-anchor" href="#生命周期-hooks" aria-hidden="true">#</a> 生命周期 Hooks</h2><h3 id="oninitialized" tabindex="-1"><a class="header-anchor" href="#oninitialized" aria-hidden="true">#</a> onInitialized</h3><ul><li><p>类型： <code>(app: App) =&gt; void | Promise&lt;void&gt;</code></p></li><li><p>详情：</p><p>该 Hook 会在 VuePress App 初始化后被立即调用。</p></li></ul><h3 id="onprepared" tabindex="-1"><a class="header-anchor" href="#onprepared" aria-hidden="true">#</a> onPrepared</h3><ul><li><p>类型： <code>(app: App) =&gt; void | Promise&lt;void&gt;</code></p></li><li><p>详情：</p><p>该 Hook 会在 VuePress App 完成文件准备后被立即调用。</p></li></ul><h3 id="onwatched" tabindex="-1"><a class="header-anchor" href="#onwatched" aria-hidden="true">#</a> onWatched</h3><ul><li><p>类型： <code>(app: App, watchers: Closable[], restart: () =&gt; Promise&lt;void&gt;) =&gt; void | Promise&lt;void&gt;</code></p></li><li><p>详情：</p><p>该 Hook 会在 VuePress App 启动开发服务器并开始监听文件修改后被调用。</p><p><code>watchers</code> 是一个文件监听器的数组。在修改配置文件导致重启 dev 命令时，这些监听器会被自动关闭。如果你在当前 Hook 中添加了新的监听器，你应该把它们也加入到这个数组中，确保在重启 dev 命令时它们能被正确关闭。</p><p><code>restart</code> 方法用来重启 dev 命令。调用该方法时， <code>watchers</code> 数组中的监听器也会被自动关闭。</p></li></ul><h3 id="ongenerated" tabindex="-1"><a class="header-anchor" href="#ongenerated" aria-hidden="true">#</a> onGenerated</h3><ul><li><p>类型： <code>(app: App) =&gt; void | Promise&lt;void&gt;</code></p></li><li><p>详情：</p><p>该 Hook 会在 VuePress App 完成静态文件生成后被立即调用。</p></li></ul>',9);function D(I,M){const t=r("NpmBadge"),s=r("ExternalLinkIcon"),l=r("RouterLink");return p(),u("div",null,[v,n(t,{package:"@vuepress/core"}),e("p",null,[i("插件 API 是由 "),e("a",m,[i("@vuepress/core"),n(s)]),i(" 包支持的。你可以查看 "),n(l,{to:"/DocVuepress/Java/reference/node-api.html"},{default:a(()=>[i("Node API")]),_:1}),i(" 来了解如何使用插件 Hooks 中的 VuePress App 实例。")]),h,e("blockquote",null,[e("p",null,[i("查看 "),n(l,{to:"/DocVuepress/Java/advanced/architecture.html#%E6%A0%B8%E5%BF%83%E6%B5%81%E7%A8%8B%E4%B8%8E-hooks"},{default:a(()=>[i("深入 > 架构 > 核心流程与 Hooks")]),_:1}),i(" 来更好地理解该流程。")])]),b,e("ul",null,[e("li",null,[i("参考： "),e("ul",null,[e("li",null,[n(l,{to:"/DocVuepress/Java/reference/client-api.html#defineclientconfig"},{default:a(()=>[i("客户端 API > defineClientConfig")]),_:1})]),e("li",null,[n(l,{to:"/DocVuepress/Java/advanced/cookbook/usage-of-client-config.html"},{default:a(()=>[i("深入 > Cookbook > 客户端配置的使用方法")]),_:1})])])])]),g,e("p",null,[i("添加默认的 "),e("a",f,[i("app.compilerOptions.isCustomElement"),n(s)]),i(" 配置：")]),_,e("ul",null,[e("li",null,[i("参考： "),e("ul",null,[e("li",null,[n(l,{to:"/DocVuepress/Java/reference/bundler/vite.html"},{default:a(()=>[i("打包工具 > Vite")]),_:1})]),e("li",null,[n(l,{to:"/DocVuepress/Java/reference/bundler/webpack.html"},{default:a(()=>[i("打包工具 > Webpack")]),_:1})])])])]),k,e("ul",null,[e("li",null,[i("参考： "),e("ul",null,[e("li",null,[n(l,{to:"/DocVuepress/Java/reference/config.html#markdown"},{default:a(()=>[i("配置 > markdown")]),_:1})])])])]),x,e("ul",null,[P,e("li",null,[O,w,e("p",null,[i("该 Hook 接收一个函数，在参数中会收到一个由 "),e("a",A,[i("markdown-it"),n(s)]),i(" 提供的 "),y,i(" 实例。")]),H]),B]),E,e("ul",null,[e("li",null,[i("参考： "),e("ul",null,[e("li",null,[n(l,{to:"/DocVuepress/Java/reference/node-api.html#createPage"},{default:a(()=>[i("Node API > Page > createPage")]),_:1})])])])]),V,e("ul",null,[e("li",null,[i("参考： "),e("ul",null,[e("li",null,[n(l,{to:"/DocVuepress/Java/reference/client-api.html#usepagedata"},{default:a(()=>[i("客户端 API > usePageData")]),_:1})]),e("li",null,[n(l,{to:"/DocVuepress/Java/reference/node-api.html#data"},{default:a(()=>[i("Node API > Page 属性 > data")]),_:1})]),e("li",null,[n(l,{to:"/DocVuepress/Java/reference/node-api.html#routemeta"},{default:a(()=>[i("Node API > Page 属性 > routeMeta")]),_:1})])])])]),C])}const N=o(c,[["render",D],["__file","plugin-api.html.vue"]]);export{N as default};
